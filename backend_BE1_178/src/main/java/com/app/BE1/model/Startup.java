...
@Entity(name = "Startup")
@Table(name = "\"Startup\"", schema =  "\"be1_190\"")
@Data
...
@Column(name = "\"KeyMetrics\"")
    ...
    @CollectionTable(schema = "\"be1_190\"", name = "\"StartupKeyMetrics\"",joinColumns = @JoinColumn(name = "\"SId\""))
...
@JoinTable(
            ...
            inverseJoinColumns = @JoinColumn( name="\"FId\""), schema = "\"be1_190\"")
...
@JoinTable(
            ...
            joinColumns = @JoinColumn( name="\"SId\""),
            inverseJoinColumns = @JoinColumn( name="\"RoundId\""), schema = "\"be1_190\"")
